 ...
 * @returns Nothing.
 */
function applySchemaMigrationV20(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(20);
 ...
 * @returns Nothing.
 */
function applySchemaMigrationV21(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(21);
 ...
 * @returns Nothing.
 */
function applySchemaMigrationV23(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(23);
 ...
 * @returns Nothing.
 */
function applySchemaMigrationV24(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(24);
 ...
 * @returns Nothing.
 */
function applySchemaMigrationV25(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(25);
 ...
 * @returns Nothing.
 */
function applySchemaMigrationV26(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(26);
 ...
 * @returns Nothing.
 */
function applySchemaMigrationV27(database: BetterSqliteDatabase): void {
  const migration = database
    .prepare("SELECT version FROM schema_migrations WHERE version = ?")
    .get(27);
