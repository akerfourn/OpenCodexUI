...
/** Edits the current document buffer with its retained Monaco model. */
export function MonacoFileTextEditor({ document, visible }: {
...
export const MonacoFileTextEditorX = observer(MonacoFileTextEditor);
