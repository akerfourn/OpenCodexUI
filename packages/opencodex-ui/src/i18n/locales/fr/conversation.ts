...
export const frConversation = {
  ...
  goal: {
    ...
    clear: "Supprimer l'objectif",
    clearConfirmation: "Supprimer l'objectif natif de cette conversation ?",
    close: "Fermer",
    complete: "Terminé",
    description:
    ...
    error: "Impossible de gérer l'objectif : {{message}}",
    indicator: "État de l'objectif : {{status}}",
    ...
    open: "Définir ou gérer l'objectif",
    pause: "Mettre en pause",
    paused: "En pause",
    readOnly: "Ce chat est en lecture seule.",
    resume: "Reprendre",
    save: "Enregistrer la définition",
    start: "Lancer l'objectif",
    status: "État",
    title: "Gérer l'objectif natif",
  ...
  turnDiagnostics: {
    ...
    eventFilterSummary: "{{visible}} / {{total}} événements affichés",
    eventName: "Événement",
    events: "Événements",
    ...
    noMatchingEvents: "Aucun événement ne correspond aux filtres sélectionnés.",
    ...
    serviceTier: "Vitesse",
    selectedEventTypes: "{{count}} types d’événements sélectionnés",
    showAllEventTypes: "Tout afficher",
    source: "Source",
    status: "Statut",
    succeeded: "Acceptée",
  ...
  composer: {
    ...
    emoji: {
      ...
      noMatch: "Aucun emoji ne correspond à cette recherche.",
