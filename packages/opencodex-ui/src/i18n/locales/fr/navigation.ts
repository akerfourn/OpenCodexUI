...
export const frNavigation = {
  ...
  home: {
    fileLanguages: "Coloration syntaxique",
  ...
  emojiCatalog: {
    title: "Catalogue des emojis",
    description: "Personnalisez les termes utilisés pour retrouver rapidement un emoji dans le chat.",
    search: "Rechercher un emoji",
    searchPlaceholder: "Emoji ou terme associé",
    noResults: "Aucun emoji ne correspond à cette recherche.",
    selectPrompt: "Sélectionnez un emoji pour gérer ses termes associés.",
    aliasesTitle: "Termes associés",
    aliasesDescription: "Les termes par défaut restent récupérables après une mise à jour.",
    defaultAliases: "Termes par défaut",
    customAliases: "Termes personnalisés",
    hiddenAliases: "Termes masqués",
    noDefaultAliases: "Aucun terme par défaut.",
    noCustomAliases: "Aucun terme personnalisé.",
    addAlias: "Ajouter un terme",
    aliasPlaceholder: "ex. rire jaune",
    add: "Ajouter",
    reset: "Rétablir les valeurs par défaut",
    removeAlias: "Retirer le terme {{alias}}",
    restoreAlias: "Rétablir le terme {{alias}}"
  },
  rename: {
    cancel: "Annuler",
    submit: "Renommer",
