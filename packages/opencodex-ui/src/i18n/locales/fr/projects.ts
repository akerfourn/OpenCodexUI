...
export const frProjects = {
  ...
  goals: {
    ...
    collapseOtherChats: "Masquer les objectifs des autres chats",
    delete: "Supprimer l'objectif",
    deleteDescription: "Cet objectif brouillon sera supprimé définitivement.",
    deleteTitle: "Supprimer l'objectif ?",
    description: "Préparez des objectifs réutilisables pour ce projet et exécutez-les dans un chat quand vous êtes prêt.",
    ...
    empty: "Aucun objectif n'est défini pour ce projet.",
    emptyWithArchive: "Aucun objectif n'est disponible dans le catalogue sélectionné.",
    executionTitle: "Exécution",
    expandOtherChats: "Afficher les objectifs des autres chats",
    finishedCannotLaunch: "Un objectif terminé ne peut pas être relancé.",
    launch: "Lancer l'objectif",
    launchConfirmDescription: "Lancer « {{goal}} » dans le chat courant « {{chat}} » ?",
    launchConfirmTitle: "Lancer l'objectif ?",
    nameLabel: "Nom affiché",
    noChat: "Aucun chat",
    noCurrentChat: "Sélectionnez un chat avant de lancer un objectif.",
    ...
    otherChatsSection: "Objectifs d'autres chats",
    pausedOtherChat: "Un objectif en pause ne peut être repris que depuis son chat d'origine.",
    pause: "Mettre l'objectif en pause",
    pauseRequiresCurrentChat: "Ouvrez le chat associé à cet objectif avant de le mettre en pause.",
    projectEmpty: "Aucun objectif non associé n'est disponible.",
    projectSection: "Objectifs du projet",
    projectSectionDescription: "Pas encore associés à un chat.",
    resume: "Reprendre l'objectif",
    save: "Enregistrer",
    selectChatToLaunch: "Sélectionnez un chat pour lancer un objectif.",
    showArchived: "Afficher les objectifs archivés",
    sourceUnavailable: "L'exécution d'un objectif nécessite une source Codex disponible.",
