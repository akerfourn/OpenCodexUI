...
export const enNavigation = {
  ...
  home: {
    fileLanguages: "Syntax highlighting",
  ...
  emojiCatalog: {
    title: "Emoji catalogue",
    description: "Customize the terms used to quickly find an emoji in the chat.",
    search: "Search emojis",
    searchPlaceholder: "Emoji or associated term",
    noResults: "No emoji matches this search.",
    selectPrompt: "Select an emoji to manage its associated terms.",
    aliasesTitle: "Associated terms",
    aliasesDescription: "Default terms can always be restored after an update.",
    defaultAliases: "Default terms",
    customAliases: "Custom terms",
    hiddenAliases: "Hidden terms",
    noDefaultAliases: "No default terms.",
    noCustomAliases: "No custom terms.",
    addAlias: "Add a term",
    aliasPlaceholder: "e.g. awkward laugh",
    add: "Add",
    reset: "Restore defaults",
    removeAlias: "Remove the term {{alias}}",
    restoreAlias: "Restore the term {{alias}}"
  },
  rename: {
    cancel: "Cancel",
    submit: "Rename",
