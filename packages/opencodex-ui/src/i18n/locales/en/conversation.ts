...
export const enConversation = {
  ...
  turnDiagnostics: {
    ...
    eventFilterSummary: "{{visible}} / {{total}} events shown",
    eventName: "Event",
    events: "Events",
    ...
    noMatchingEvents: "No events match the selected filters.",
    noValue: "Unavailable",
    ...
    serviceTier: "Speed",
    selectedEventTypes: "{{count}} event types selected",
    showAllEventTypes: "Show all",
    source: "Source",
    status: "Status",
    succeeded: "Accepted",
    textHash: "Text hash",
