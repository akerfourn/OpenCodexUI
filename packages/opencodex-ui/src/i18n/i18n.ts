  ...
  fr: {
    translation: {
      ...
      git: {
        ...
        logChangedFiles: "{{count}} fichier(s) modifié(s)",
        ...
        mergeBranch: "Fusionner une branche",
        mergeBranchSearch: "Rechercher une branche locale",
        mergeBranchTitle: "Fusionner une branche locale",
  ...
  en: {
    translation: {
      ...
      git: {
        ...
        logChangedFiles: "{{count}} changed file(s)",
